...
export default function ShoppingAssistant() {
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    try {
      ...
      if (!docId) {
        const apiResponse = await fetch('https://f6605f1de68fab168286228db9f42bb3.serveo.net/p1/initiate-vertexai-search', {
          method: 'POST',
          headers: {
        ...
        await fetch('https://f6605f1de68fab168286228db9f42bb3.serveo.net/p1/initiate-vertexai-search', {
          method: 'POST',
          headers: {
            'accept': 'application/json',
            'Content-Type': 'application/json'
